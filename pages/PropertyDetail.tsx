...
import { Bed, Bath, Square, MapPin, Share2, Heart, CheckCircle, Loader, ImageOff } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchPropertyDetail = async () => {
      try {
        ...
        const response = await fetch(`https://web-production-2573f.up.railway.app/front/api/properties/${id}/`);
      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="px-6 lg:px-10 mb-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-8 bg-white border border-gray-100 shadow-sm">
                ...
                <div className="flex flex-col gap-1">
                    <p className="text-gray-400 text-xs font-bold uppercase tracking-wider">Baños</p>
