           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-[600px] rounded-xl overflow-hidden">
              ...
              <div className="grid grid-rows-2 gap-4 h-full">
                  <div className="relative group cursor-pointer overflow-hidden">
                    <div className="w-full h-full bg-gray-200 flex items-center justify-center text-gray-400">Interior Photo</div>
                  </div>
                  <div className="relative group cursor-pointer overflow-hidden">
                    <div className="w-full h-full bg-gray-200 flex items-center justify-center text-gray-400">Kitchen Photo</div>
                  </div>
              </div>
           </div>
        </div>
        ...
        <div className="px-6 lg:px-10 mb-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-8 bg-white border border-gray-100 shadow-sm">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <div className="flex items-center gap-2"><Bath className="text-primary" /><p className="text-2xl font-serif font-bold">{property.baths}</p></div>
                </div>
                <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-col gap-1">
                    <p className="text-gray-400 text-xs font-bold uppercase tracking-wider">Type</p>
        ...
        <div className="px-6 lg:px-10 flex flex-col lg:flex-row gap-16">
            ...
            <div className="flex-1">
                <section className="mb-12">
                    <h2 className="text-2xl font-serif font-bold mb-6 border-b border-gray-200 pb-4">Description</h2>
                    <div className="prose max-w-none text-lg leading-relaxed text-gray-600">
                        {/* AQUÍ ESTABA EL ERROR 1: Usamos un texto por defecto si no hay descripción */}
                        <p className="mb-6">{property.description || "No description available for this property yet."}</p>
                    </div>
                </section>
                ...
                <section className="mb-12">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {/* AQUÍ ESTABA EL ERROR 2: Usamos ?. para evitar fallos si no hay features */}
